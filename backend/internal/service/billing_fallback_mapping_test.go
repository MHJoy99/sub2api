...
func TestFallbackPricingCoversCompositeAndUnmappedAliases(t *testing.T) {
	...
	tests := []struct {
		...
		{model: "alibaba-token-plan-deepseek-v4-flash-0731", input: 1.4e-7, output: 2.8e-7, cacheRead: 2.8e-9},
		{model: "alibaba-token-plan-deepseek-v4-pro-0813", input: 4.35e-7, output: 8.7e-7, cacheRead: 3.625e-9},
		{model: "accounts/fireworks/models/deepseek-v4-flash-0731", input: 1.4e-7, output: 2.8e-7, cacheRead: 2.8e-9},
		...
		{model: "go-deepseek-v4-flash", input: 1.4e-7, output: 2.8e-7, cacheRead: 2.8e-9},
		{model: "go-deepseek-v4-pro", input: 4.35e-7, output: 8.7e-7, cacheRead: 3.625e-9},
