...
func TestFallbackPricingCoversCompositeAndUnmappedAliases(t *testing.T) {
	...
	tests := []struct {
		...
		{model: "gemini-3.5-flash-lite", input: 1.5e-6, output: 9e-6, cacheRead: 0.15e-6},
		{model: "gemini-3.8-flash-tiered", input: 0.75e-6, output: 3.75e-6, cacheRead: 0.075e-6},
		{model: "gemini-3.8-flash", input: 0.75e-6, output: 3.75e-6, cacheRead: 0.075e-6},
		...
		{model: "go-longcat-2.0", input: 0.3e-6, output: 1.2e-6, cacheRead: 0.006e-6},
		{model: "longcat-2.0", input: 0.3e-6, output: 1.2e-6, cacheRead: 0.006e-6},
		{model: "go-hy3", input: 0.14e-6, output: 0.58e-6, cacheRead: 0.035e-6},
		{model: "hy3", input: 0.14e-6, output: 0.58e-6, cacheRead: 0.035e-6},
